      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Gautham G Rao</h3>
            <p className="text-gray-300 mb-4">
              Cloud Specialist & AI Engineer passionate about building scalable generative AI applications
              and modern web solutions.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://linkedin.com/in/ggrao"
                target="_blank"
              ...
              <a
                href="mailto:gatthamgrao97@gmail.com"
                className="text-gray-300 hover:text-white transition-colors"
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            &copy; {new Date().getFullYear()} Gautham G Rao. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
